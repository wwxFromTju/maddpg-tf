...
if __name__ == '__main__':
    ...
    for i in range(1000000):
        ...
        for agent_index in range(3):
            ...
            summary_writer.add_summary(sess.run(agent_a1_op[agent_index], {agent_a1[agent_index]: a[agent_index][1]}), i)
            summary_writer.add_summary(sess.run(agent_a2_op[agent_index], {agent_a2[agent_index]: a[agent_index][3]}), i)
            summary_writer.add_summary(sess.run(reward_100_op[agent_index], {reward_100[agent_index]: np.mean(reward_100_list[agent_index][-100:])}), i)
